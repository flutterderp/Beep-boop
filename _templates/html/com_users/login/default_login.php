		...
		<fieldset>
			...
			<div class="control-group">
				<div class="controls button-group">
					<button type="submit" class="button"><span class="fa fa-sign-in-alt"></span> <?php echo JText::_('JLOGIN'); ?></button>
					<?php
					$usersConfig = JComponentHelper::getParams('com_users');
					if ($usersConfig->get('allowUserRegistration')) : ?>
						<a class="button" href="<?php echo JRoute::_('index.php?option=com_users&view=registration'); ?>"><?php echo JText::_('COM_USERS_LOGIN_REGISTER'); ?></a>
					<?php endif; ?>
					<a class="button secondary" href="<?php echo JRoute::_('index.php?option=com_users&view=reset'); ?>">
						<span class="fa fa-question"></span> <?php echo JText::_('COM_USERS_LOGIN_RESET'); ?>
					</a>
					<a class="button secondary" href="<?php echo JRoute::_('index.php?option=com_users&view=remind'); ?>">
						<span class="fa fa-question"></span> <?php echo JText::_('COM_USERS_LOGIN_REMIND'); ?>
					</a>
				</div>
				<ul>
