...
$headerClass   = !empty($headerClass) ? ' class="' . htmlspecialchars($headerClass, ENT_COMPAT, 'UTF-8') . ' text-center"' : ' class="text-center"';

echo '<div class="row"><div class="small-12 medium-8 medium-offset-2 columns">';
